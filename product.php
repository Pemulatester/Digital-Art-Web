...
<html lang="en">
	<head>
    	...
    	<title>Digital Art - Online Shopping in Pakistan</title>
			...
			<div class="border-0">
				<div class="row">
					...
					<aside class="col-sm-5">
						<article class="card-body m-0 pt-0 pl-5">
							...
							<div class="mb-3 mt-3"> 
								...
								<span class="price color-price-waanbii">Rp.<?php echo $productprice ?> </span>
							</div>
					...
					<aside class="col-sm-3">
						...
						<hr class="m-0 p-0">
						<div class="row mb-4 mt-4">
							Mari silahkan di order ദ്ദി(˵ •̀ ᴗ - ˵ ) ✧
						</div>
					</aside>
				</div>
			</div>
		...
		<footer class="ct-footer">
			<div class="container">
				<ul class="ct-footer-list text-center-sm">
				    ...
				    <li>
				        <h2 class="ct-footer-list-header">Digital Art</h2>
				        <ul>
					        <li>
					            <a href="info.php">About Us</a>
					        </li>
		  	...
		  	<div class="ct-footer-post">
		    	<div class="container">
		      		...
		      		<div class="inner-right">
		        		<p>Copyright © 2023 Digital ArtCo.&nbsp;<a href="">Privacy Policy</a></p>
		        		<p><a class="ct-u-motive-color" href="" target="_blank">Web Design</a> by --- <a href="" target="_blank">Digital Art.com</a></p>
		      		</div>
		    	</div>
		  	</div>
		</footer>
